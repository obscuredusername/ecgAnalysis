...
def denoise_csv():
    ...
    # Load CSV file
    csv_file_path = './result_folder/required.csv'
    ...
    # Assuming your signal is in the second column (index 1) onwards
    signal_column_index = 1
    signal_data = [float(row[signal_column_index]) for row in data]

    # Example usage of the denoising function
    denoised_signal = NLM_1dDarbon(signal_data, Nvar=1, P=1, PatchHW=1)

    # Print or save the denoised signal as needed
